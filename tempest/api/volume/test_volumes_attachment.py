...
@attr(type='falcon')
class VolumesV2AttachmentTest(base.BaseVolumeTest):

    @classmethod
    def setup_clients(cls):
        super(VolumesV2AttachmentTest, cls).setup_clients()
    ...
    def resource_setup(cls):
        super(VolumesV2AttachmentTest, cls).resource_setup()
    ...
    def resource_cleanup(cls):
        ...
        super(VolumesV2AttachmentTest, cls).resource_cleanup()
...
#class VolumesV1AttachmentTest(VolumesV2AttachmentTest):
#    _api_version = 1
